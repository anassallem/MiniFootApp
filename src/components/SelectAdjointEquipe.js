...
import SingleMembreTeam from './common/SingleMembreTeam';
import { getMembresTeam } from '../actions';

class SelectAdjointEquipe extends Component {
    componentWillMount() {
    ...
    renderRow(player) {
        return <SingleMembreTeam player={player} />;
    }
...
export default connect(mapStateToProps, { getMembresTeam })(SelectAdjointEquipe);
